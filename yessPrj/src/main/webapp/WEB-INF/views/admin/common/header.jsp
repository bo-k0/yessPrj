...
.menu__toggle-label a:nth-of-type(2) {
  left: 250px;
  transform: scale(0);
}
.menu__toggle {
...
.menu__toggle:checked ~ .menu__toggle-label a:nth-of-type(1) {
  transform: scale(0);
}
.menu__toggle:checked ~ .menu__toggle-label a:nth-of-type(2) {
  left: 250px;
  transform: scale(1);
  transition: transform 0.15s;
