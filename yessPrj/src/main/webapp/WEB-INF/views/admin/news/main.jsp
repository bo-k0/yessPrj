            ...
            <div class="news-notice">
                ...
                <c:forEach var="newsList" items="${newsList}" begin="0" end="5" step="1">
                	<c:choose>
                		...
                		<c:otherwise><a href="${root}/admin/news/detail?no=${newsList.no}">${newsList.title}</a></c:otherwise>
                	</c:choose>                					
				</c:forEach>
                </div>
            </div>
            <div class="news-notice">
                ...
                <c:forEach var="areaList" items="${areaList}" begin="0" end="5" step="1">
                	<c:choose>
                		...
                		<c:otherwise><a href="${root}/admin/news/detail?no=${areaList.no}">${areaList.title}</a></c:otherwise>
                	</c:choose>					
				</c:forEach>
                </div>
            </div>
            <div class="news-notice">
                ...
                <c:forEach var="noticeList" items="${noticeList}" begin="0" end="5" step="1">
                	<c:choose>
                		...
                		<c:otherwise><a href="${root}/admin/news/detail?no=${noticeList.no}">${noticeList.title}</a></c:otherwise>
                	</c:choose>					
				</c:forEach>
                </div>
            </div>
        ...
        <div class="news-rank-box">
            ...
            <div class="rank-box">
                ...
                <div class="rank">
                    ...
                    <div class="rank-line"><p class="rank-number rank-number-top">2</p><div><img src="${root}/resources/img/grade/g5.png"></div><p class="ranker-name rank-number-top">${rankAllList[1].nick}<i style="color:silver;" class="fa-solid fa-medal"></i></p></div>
                    <div class="rank-line"><p class="rank-number rank-number-top">3</p><div><img src="${root}/resources/img/grade/g5.png"></div><p class="ranker-name rank-number-top">${rankAllList[2].nick}<i style="color:#CD7F32;" class="fa-solid fa-medal"></i></p></div>
