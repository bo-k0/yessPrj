  ...
  <div class="body-warp">
        <div class="mypage-warp">
            <div class="mypage-category">
                ...
                <a id="member" href="${root}/admin/member2/qnaList"><span>QnA</span></a>
                ...
                <div class="mypage-form-wrap">
                    <div class="mypage-member-grade">
                        <div id="second-box-content">
			              ...
			              <div id="second-box-content-title">문의유형</div>
			              <div id="second-box-content-title">제목</div>
			              <div id="second-box-content-title">문의내용</div>
			              <div id="second-box-content-title">작성일자</div>
