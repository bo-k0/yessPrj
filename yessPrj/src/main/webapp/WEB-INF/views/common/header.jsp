...
.left-head-menu i{
	...
	<div class="main-side-menu" id="msm">
        <div class="main-side-menu-inner">
            ...
            <a href="<c:url value='/news/main'/>" class="side-menu-title">NEWS</a>
            ...
            <a href="<c:url value='/whereTo/main'/>" class="side-menu-title">Where To YeSS</a>
    ...
    <header>
        ...
        <a href="<c:url value='/main'/>" class="center-head-menu"><img src="<c:url value='/resources/img/common/YeSS.png'/>"/></a>
