    ...
    <nav class="head-side-menu">
        ...
        <li class="menu-item">            
            ...
            <c:if test="${not empty loginMember}">
            	<a href="${root}/member/logout" id="logoutBtn" onMouseOver="this.innerHTML='로그아웃'" onMouseOut="this.innerHTML='LOGOUT'">LOGOUT</a>
            </c:if>
		            ...
		            <a class="right-head-menu-mypage"><i class="fa-solid fa-user"></i></a>
				        <c:choose>
				        	<c:when test="${not empty loginMember}">
					            <a href="${root}/mypage/main" class="right-head-menu-btn">${loginMember.nick}님</a>						                	
				        	</c:when>
					    	<c:otherwise>
