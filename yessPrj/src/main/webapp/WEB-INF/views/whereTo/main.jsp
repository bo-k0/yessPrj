...
<body>
    ...
    <div class="where-banner">
        <p>Where To YeSS</p>
        <img src="<c:url value='/resources/img/whereTo/whereTo.jpg'/>"/>
    </div>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=54c1db7c3aaa1000c7e68e8a2dfb2f48"></script>
