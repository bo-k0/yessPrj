...
COMMENT ON COLUMN "NOTICE"."ADMIN_NO" IS '회원번호(관리자전용)';

COMMENT ON COLUMN "NOTICE"."NOTICE_TYPE_NO" IS '카테고리 번호';
...
COMMENT ON COLUMN "NOTICE_TYPE"."NO" IS '카테고리 번호';

COMMENT ON COLUMN "NOTICE_TYPE"."TYPE" IS '공지사항 카테고리';
...
CREATE SEQUENCE SEQ_NOTICE_NO NOCYCLE;
...
DROP SEQUENCE SEQ_NOTICE_TYPE_NO;
CREATE SEQUENCE SEQ_NOTICE_TYPE_NO NOCYCLE;
