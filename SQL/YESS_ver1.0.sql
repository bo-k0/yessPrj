...
COMMENT ON COLUMN "COMMUNITY"."NO" IS '글번호';

COMMENT ON COLUMN "COMMUNITY"."MEMBER_NO" IS '회원번호';

COMMENT ON COLUMN "COMMUNITY"."TITLE" IS '글제목';

COMMENT ON COLUMN "COMMUNITY"."CONT" IS '글내용';

COMMENT ON COLUMN "COMMUNITY"."ENROLL_DATE" IS '작성일시';

COMMENT ON COLUMN "COMMUNITY"."DELETE_YN" IS '삭제여부
체크제약조건';

COMMENT ON COLUMN "COMMUNITY"."MODIFY_DATE" IS '최종수정일시';
...
CREATE TABLE "YESSMALL_PROD" (
	"NO"	NUMBER		NOT NULL,
	"YESSMALL_CATEGORY_NO"	NUMBER		NOT NULL,
	"NAME"	VARCHAR2(50)		NOT NULL,
	"INFO"	VARCHAR2(4000)		NOT NULL,
	"DETAIL"	CLOB		NOT NULL,
	"PRICE"	NUMBER		NOT NULL,
	"STOCK"	NUMBER	DEFAULT 100	NOT NULL
);

COMMENT ON COLUMN "YESSMALL_PROD"."NAME" IS '이름';

COMMENT ON COLUMN "YESSMALL_PROD"."INFO" IS '제품 소개';

COMMENT ON COLUMN "YESSMALL_PROD"."DETAIL" IS '제품 상세 소개';

COMMENT ON COLUMN "YESSMALL_PROD"."PRICE" IS '가격';

COMMENT ON COLUMN "YESSMALL_PROD"."STOCK" IS '재고 수량';


CREATE TABLE "YESSMALL_REVIEW" (
	"NO"	NUMBER		NOT NULL,
	"MEMBER_NO"	NUMBER		NOT NULL,
	"YESSMALL_PROD_NO"	NUMBER		NOT NULL,
...
COMMENT ON COLUMN "COMMUNITY_ATTACHMENT"."COMMUNITY_NO" IS '글번호';
...
COMMENT ON COLUMN "COMMUNITY_LIKED"."COMMUNITY_NO" IS '글번호';

COMMENT ON COLUMN "COMMUNITY_LIKED"."MEMBER_NO" IS '회원번호';
...
COMMENT ON COLUMN "COMMUNITY_CMT"."NO" IS '자유게시판 댓글 번호';

COMMENT ON COLUMN "COMMUNITY_CMT"."COMMUNITY_NO" IS '글번호';

COMMENT ON COLUMN "COMMUNITY_CMT"."MEMBER_NO" IS '회원번호';

COMMENT ON COLUMN "COMMUNITY_CMT"."CMT" IS '댓글 내용';

COMMENT ON COLUMN "COMMUNITY_CMT"."CMT_DATE" IS '작성 날짜';

COMMENT ON COLUMN "COMMUNITY_CMT"."DELETE_YN" IS '삭제 여부';

COMMENT ON COLUMN "COMMUNITY_CMT"."MODIFY_DATE" IS '최종 수정 일시';
...
ALTER TABLE "COMMUNITY_ATTACHMENT" ADD CONSTRAINT "PK_COMMUNITY_ATTACHMENT" PRIMARY KEY (
	"NO"
);
...
ALTER TABLE "COMMUNITY_TYPE" ADD CONSTRAINT "PK_COMMUNITY_TYPE" PRIMARY KEY (
	"NO"
);
...
ALTER TABLE "COMMUNITY_CMT" ADD CONSTRAINT "PK_COMMUNITY_CMT" PRIMARY KEY (
	"NO"
);
...
ALTER TABLE "COMMUNITY" ADD CONSTRAINT "FK_COMMUNITY_TYPE_TO_COMMUNITY_1" FOREIGN KEY (
	"COMMUNITY_TYPE_NO"
)
...
ALTER TABLE "REPORT" ADD CONSTRAINT "FK_REPORT_BOARD_TYPE_TO_REPORT_1" FOREIGN KEY (
	"BOARD_TYPE_NO"
)
...
ALTER TABLE "QNA" ADD CONSTRAINT "FK_QNA_TYPE_TO_QNA_1" FOREIGN KEY (
	"QNA_TYPE_NO"
)
REFERENCES "QNA_TYPE" (
	"NO"
...
ALTER TABLE "RECYCLE" ADD CONSTRAINT "FK_RECYCLE_TYPE_TO_RECYCLE_1" FOREIGN KEY (
	"RECYCLE_TYPE_NO"
)
REFERENCES "RECYCLE_TYPE" (
	"NO"
);
...
ALTER TABLE "ATTEND" ADD CONSTRAINT "FK_MEMBER_TO_ATTEND_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"NO"
...
ALTER TABLE "RECYCLE_LIKED" ADD CONSTRAINT "FK_MEMBER_TO_RECYCLE_LIKED_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"NO"
...
ALTER TABLE "RECYCLE_LIKED" ADD CONSTRAINT "FK_RECYCLE_TO_RECYCLE_LIKED_1" FOREIGN KEY (
	"RECYCLE_NO"
)
REFERENCES "RECYCLE" (
	"NO"
...
ALTER TABLE "MARKET" ADD CONSTRAINT "FK_MARKET_TYPE_TO_MARKET_1" FOREIGN KEY (
	"MARKET_TYPE_NO"
)
REFERENCES "MARKET_TYPE" (
	"NO"
);

ALTER TABLE "MARKET_CMT" ADD CONSTRAINT "FK_MEMBER_TO_MARKET_CMT_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"NO"
...
ALTER TABLE "MARKET_CMT" ADD CONSTRAINT "FK_MARKET_TO_MARKET_CMT_1" FOREIGN KEY (
	"MARKET_NO"
)
REFERENCES "MARKET" (
	"NO"
...
ALTER TABLE "COMMUNITY_ATTACHMENT" ADD CONSTRAINT "FK_COMMUNITY_TO_COMMUNITY_ATTACHMENT_1" FOREIGN KEY (
	"COMMUNITY_NO"
)
...
ALTER TABLE "POINT_HISTORY" ADD CONSTRAINT "FK_POINT_PLACE_TO_POINT_HISTORY_1" FOREIGN KEY (
	"POINT_PLACE_NO"
)
REFERENCES "POINT_PLACE" (
	"NO"
);

ALTER TABLE "COMMUNITY_LIKED" ADD CONSTRAINT "FK_COMMUNITY_TO_COMMUNITY_LIKED_1" FOREIGN KEY (
	"COMMUNITY_NO"
)
REFERENCES "COMMUNITY" (
	"NO"
...
ALTER TABLE "ZZIM" ADD CONSTRAINT "FK_MARKET_TO_ZZIM_1" FOREIGN KEY (
	"MARKET_NO"
)
REFERENCES "MARKET" (
	"NO"
...
ALTER TABLE "MARKET_ATTACHMENT" ADD CONSTRAINT "FK_MARKET_TO_MARKET_ATTACHMENT_1" FOREIGN KEY (
	"MARKET_NO"
)
REFERENCES "MARKET" (
	"NO"
...
ALTER TABLE "RECYCLE_ATTACHMENT" ADD CONSTRAINT "FK_RECYCLE_TO_RECYCLE_ATTACHMENT_1" FOREIGN KEY (
	"RECYCLE_NO"
)
REFERENCES "RECYCLE" (
	"NO"
...
ALTER TABLE "COMMUNITY_CMT" ADD CONSTRAINT "FK_COMMUNITY_TO_COMMUNITY_CMT_1" FOREIGN KEY (
	"COMMUNITY_NO"
)
REFERENCES "COMMUNITY" (
	"NO"
...
ALTER TABLE "COMMUNITY_CMT" ADD CONSTRAINT "FK_MEMBER_TO_COMMUNITY_CMT_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"NO"
...
DROP SEQUENCE SEQ_YESSMALL_CATEGORY_NO;
CREATE SEQUENCE SEQ_YESSMALL_CATEGORY_NO NOCYCLE;
...
DROP SEQUENCE SEQ_COMMUNITY_ATTACHMENT_NO;
CREATE SEQUENCE SEQ_COMMUNITY_ATTACHMENT_NO NOCYCLE;
DROP SEQUENCE SEQ_POINT_HISTORY_NO;
CREATE SEQUENCE SEQ_POINT_HISTORY_NO NOCYCLE;
DROP SEQUENCE SEQ_COMMUNITY_TYPE_NO;
CREATE SEQUENCE SEQ_COMMUNITY_TYPE_NO NOCYCLE;
DROP SEQUENCE SEQ_COMMUNITY_LIKED_NO;
CREATE SEQUENCE SEQ_COMMUNITY_LIKED_NO NOCYCLE;
...
DROP SEQUENCE SEQ_COMMUNITY_CMT_NO;
CREATE SEQUENCE SEQ_COMMUNITY_CMT_NO NOCYCLE;
