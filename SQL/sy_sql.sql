...
D.PROD_NO, D.CNT, P.PROD_NAME, P.PROD_PRICE,A.CHANGE_NAME
FROM "ORDER" O
JOIN PAYMENT P
ON O.NO = P.ORDER_NO
JOIN ORDER_DETAIL D
...
--주문상세내역조회
SELECt O.NO, D.PROD_NO, D.CNT,P.PROD_CATE_NO, P.PROD_NAME, P.PROD_PRICE,A.CHANGE_NAME
FROM "ORDER" O
JOIN ORDER_DETAIL D
ON O.NO = D.ORDER_NO
JOIN YESSMALL_PROD P
...
INSERT INTO POINT_PLACE VALUES(2, '예쓰몰 구매');
